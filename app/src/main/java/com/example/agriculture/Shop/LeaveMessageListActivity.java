...
import com.example.agriculture.message.PostLeaveMessageActivity;
...
/**
 */
public class LeaveMessageListActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_post_message);
        initview();
        initdate(true);
        initevetn();
    }
    private void initevetn() {
        ...
        adapter.setonDelTimeLineLitner(new MyLeaveMessageAdapter.onDelRecordLitner() {
            ...
            public void del(final int pos) {
                AlertDialog.Builder builder = new AlertDialog.Builder(LeaveMessageListActivity.this);
                builder.setTitle("提示");
